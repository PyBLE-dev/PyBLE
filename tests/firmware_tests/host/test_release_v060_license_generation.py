...
FINAL_NOTICE = "Synthetic reviewed v0.6.0 notice fixture.\n"
...
class GenerationFixture:
    ...
    def generate_esp_evidence(self, **kwargs):
        ...
        write_canonical_json(
            ...
            {
                "schema_version": 1,
                "notice_sha256": sha256_bytes(FINAL_NOTICE.encode("utf-8")),
        ...
        return {
            "third_party_licenses": FINAL_NOTICE,
            "input_sha256": {"semantic/esp-v2": "5" * 64},
        }
...
class V060LicenseGenerationTests(unittest.TestCase):
    ...
    def semantic_replay(self, **kwargs) -> None:
        ...
        self.assertEqual(kwargs["notice"], FINAL_NOTICE)
        self.assertEqual(
