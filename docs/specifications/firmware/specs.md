...
- **FR-RUN-8** — On the normal path where its pre-created grace timer arms
  ...
  effect. Response-submission failure MUST resolve the gate without stop intent,
